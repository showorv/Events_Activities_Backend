...
exports.updateEventSchema = zod_1.z.object({
    name: zod_1.z.string("Event name must be a string").optional(),
    type: zod_1.z.string("Event type must be a string").optional(),
    date: zod_1.z.preprocess((arg) => (typeof arg === "string" || arg instanceof Date ? new Date(arg) : arg), zod_1.z.date("Event date must be a valid date")).optional(),
    time: zod_1.z.string("Event time must be a string").optional(),
    location: zod_1.z.string("Event location must be a string").optional(),
    minParticipants: zod_1.z.number("Minimum participants must be a number").int().positive().optional(),
    maxParticipants: zod_1.z.number("Maximum participants must be a number").int().positive().optional(),
    joiningFee: zod_1.z.number().optional(),
    description: zod_1.z.string().optional(),
    status: exports.EventStatusEnum.optional(),
});
