...
const sslcomerzInitialize = async (payload) => {
    try {
        const data = {
...
const validatePayment = async (payload) => {
    try {
        ...
        await payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGateway: response.data }, { runValidators: true });
    }
    catch (error) {
